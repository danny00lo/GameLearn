module BlackJack {
    ...
    */
    export class Index extends egret.DisplayObjectContainer {
        ...
        /**注册首页常量 */
        private indexBackground: egret.Bitmap;
        private indexDiamondIcon: egret.Bitmap;
        private indexDiamondText: egret.BitmapText;
        private indexTitle: egret.Bitmap;
        private plusDiamondsPOP: egret.Bitmap;
        private plusDiamondsText: egret.TextField;
        private plusDiamondsCancel: egret.TextField;
        private plusDiamondsConfirm: egret.TextField;
        private plusDiamondsCancelListen: any;
        private plusDiamondsConirmListen: any;

        // 教程布局
        private teachBackground: egret.Bitmap;
        private teachMusic: egret.Bitmap;
        private teachHelp: egret.Bitmap;
        private teachFill: egret.Shape;
        private teachScore1: egret.Bitmap;
        private teachScore2: egret.Bitmap;
        private teachScore3: egret.Bitmap;
        private teachScore4: egret.Bitmap;
        private teachScore5: egret.Bitmap;
        private teachClear: egret.Bitmap;
        private teachClick1: egret.Bitmap;
        private teachClick2: egret.Bitmap;
        private teachClick3: egret.Bitmap;
        private teachClick4: egret.Bitmap;
        private teachClick5: egret.Bitmap;
        private teachText1: egret.Bitmap;
        private teachText2: egret.Bitmap;
        private teachText3: egret.Bitmap;
        private teachText4: egret.Bitmap;
        private teachTextIcon1: egret.Bitmap;
        private teachTextIcon2: egret.Bitmap;
        private teachTextIcon3: egret.Bitmap;
        private teachTextIcon4: egret.Bitmap;
        private teachConsBackground: egret.Bitmap;
        private teachConsText: egret.TextField;
        private teachTextScore: egret.Bitmap;
        private textHeadIcon: egret.Bitmap;
        private textHeadIconReal: egret.Bitmap;
        private createTeachIconListen: any


        /**创建黑杰克游戏首页 */
        public createStart(that): void {
            // 注册大小
        ...
        /**弹出窗口取消 */
        public popWindonwCancel(that): void {
        ...
        /**弹出窗口确定 */
        public popWindowConfirm(that): void {
            // this.plusDiamondsConfirm.touchEnabled = false;
            // this.plusDiamondsCancel.touchEnabled = false;
        ...
        /**移除黑杰克首页配套 */
        public removeStartPage(that): void {
        ...
        /**创建黑杰克 教程页 */
        public createTeachPage(that): void {
            let clientWidth = that.stage.stageWidth / 750;
            let clientHeight = that.stage.stageHeight / 1206;
            ...
            // 创建动态头像
            this.createTeachIconListen = event => {
                this.createTeachIcon(event, that);
            }
            let texture = RES.getResByUrl(sessionStorage.getItem('userImg'), this.createTeachIconListen, this, RES.ResourceItem.TYPE_IMAGE);
        }

        /**创建动态人头像 */
        private createTeachIcon(event: any, that): void {
            let clientWidth = that.stage.stageWidth / 750;
            let clientHeight = that.stage.stageHeight / 1206;
